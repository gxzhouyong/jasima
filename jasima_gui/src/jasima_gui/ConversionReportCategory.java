...
public enum ConversionReportCategory {
	...
	ALLOWED_VALUES_CHANGED("The following properties could not be set to the previously saved values:"), //
	TYPE_CHANGED("The following properties now have an incompatible type:");
